...
lrs=(2.5e-05)
LEVELS=("note" "measure" "beat" "voice" "total_note_cat")

# for lr in "${lrs[@]}"
# do
# for level in "${LEVELS[@]}"
# do
#     # "yml_path_ymls/shared/label19/han_bigger256_concat.yml_multi_level_beat_no_augment_True_label_file_path_label_2round_mean_reg_19_with0_rm_highstd0.json_batch_size_8_lr_2.5e-05_intermediate_loss_False"
...
#             --device "cuda" \
#             --multi_level ${level} \
#             --make_log "False" | tee checkpoints_2rounds_align/performerfold/level/note/han_concat_bigger256_noaugment_lr${lr}_${level}_eval.log
#     done
# done
# done
