...
do
    ...
    do  
        echo $checkpoint        
            checkpointt="/root/v2/muzic/virtuosonet/checkpoints_2rounds_align/performerfold_perffeatonly/level/${level}/foldx/${checkpoint}"
            ...
            -data m2pf_allround/performer4fold_perffeatonly/foldx \
            --batch_size 1 \
            ...
            --device "cuda" \
            --multi_level ${level} \
            --make_log "False" | tee checkpoints_2rounds_align/performerfold_perffeatonly/level/${level}/han_concat_bigger256_noaugment_lr${lr}_${level}_eval.log
    done
done
done