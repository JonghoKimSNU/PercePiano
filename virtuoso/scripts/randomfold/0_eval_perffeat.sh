...
do
    ...
    do  
        echo $checkpoint
            checkpointt="/root/v2/muzic/virtuosonet/checkpoints_2rounds_align/randomfold_perffeatonly/base/foldx/${checkpoint}"
            ...
            -data m2pf_allround/random8fold_perffeatonly/foldx \
            --batch_size 1 \
            ...
            -reTrain "true" \
            --device "cuda" \
            --make_log "False" | tee /root/v2/muzic/virtuosonet/checkpoints_2rounds_align/randomfold_perffeatonly/base/han_concat_bigger256_noaugment_lr${lr}_eval.log
    done
done
...
#     do  
#         echo $checkpoint
#             checkpointt="/root/v2/muzic/virtuosonet/checkpoints_2rounds_align/randomfold_perffeatonly/note/foldx/${checkpoint}"
#             python virtuoso/eval_main.py \
#             -yml ymls/shared/label19/han_bigger256_concat.yml \
#             --label_file_path label_2round_mean_reg_19_with0_rm_highstd0.json \
#             -data m2pf_allround/random8fold_perffeatonly/foldx \
...
#             --device "cuda" \
#             --multi_level "note" \
#             --make_log "False" | tee /root/v2/muzic/virtuosonet/checkpoints_2rounds_align/randomfold_perffeatonly/note/han_concat_bigger256_noaugment_lr${lr}_eval.log
#     done
# done