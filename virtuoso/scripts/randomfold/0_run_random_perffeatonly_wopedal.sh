...
do
    ...
    -data m2pf_allround/random8fold_perffeatonly_wopedal/${fold} \
    --label_file_path label_2round_mean_reg_19_with0_rm_highstd0.json \
    --batch_size 8 \
    -dev cuda \
    --num_labels 19 \
    --checkpoints_dir /root/v2/muzic/virtuosonet/checkpoints_2rounds_align/randomfold_perffeatonly_wopedal/level/${level}/fold${fold}/ \
    --lr $lr \
    --no_augment \
    --multi_level ${level}
done
