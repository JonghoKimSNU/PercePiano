...
if __name__ == "__main__":
    ...
    dataset = data_class.YamahaDataset(args.dataset_path, save=args.save_from_beginning, features_only=args.load_feature_only) # 이건 그냥 xml_list, score_midis, perform_lists, composers, label 가져오는 용도
