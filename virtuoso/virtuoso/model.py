...
class VirtuosoNet(nn.Module):
    def __init__(self, net_param, data_stats):
        ...
        # 악보 -> score -> decoder (음표하나별로 맞춰야하는 상황. 지금 tempo, dynamic 몇인지는 디코더에 바로 연결)
        self.residual_info_selector = getattr(res, net_param.residual_info_selector_name)(data_stats) # TODO: what is it?
